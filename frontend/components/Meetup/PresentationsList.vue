            ...
            <div class="block self-center lg:w-1/3">
              ...
              <div class="w-full flex-col">
                <div class="mx-9 block items-center space-y-4 text-base sm:flex sm:space-y-0 sm:space-x-16">
                  <a v-if="presentation.youtube" :href="presentation.youtube" target="_blank" rel="noopener" class="group flex w-fit space-x-2 font-semibold transition hover:scale-105 md:space-x-3">
                    <div class="h-6 w-6 ">
                  ...
                  <a v-if="presentation.slideshare" :href="presentation.slideshare" target="_blank" rel="noopener" class="group flex w-fit space-x-2 font-semibold transition hover:scale-105 md:space-x-3">
