...
<template>
  <div class="bg-white">
    <div class="mx-auto max-w-7xl py-6 px-4 sm:px-6 lg:px-8 lg:py-12">
      <div class="block m-8">
        <div class="text-center mb-14 text-3xl font-bold tracking-tight sm:text-4xl">
          <h2 class="text-3xl font-bold tracking-tight sm:text-4xl">Prezentacje na najbliższym spotkaniu <br>
            <span class="text-laravel">10 listopada 2022r.</span><br>
            <span v-if="!Meetup.presentations.length">pojawią się tutaj już niedługo!</span>
          </h2>
        </div>
        <div class="">
