          ...
          <ul role="list" class="space-y-12 font-bold sm:grid sm:grid-cols-2 sm:gap-x-6 sm:gap-y-12 sm:space-y-0 lg:gap-x-8">
            <li v-for="person in people" :key="person.name">
              <div class="space-y-4">
                ...
                <div class="text-lg">
                  <router-link :to="{ name: 'meetups' }"><p class="text-2xl bold">{{ person.bio }}</p></router-link>
                </div>
...
const people = [
  {
    ...
    company: 'Blumilk',
    image:
      '../../../public/images/speakers/marcintracz.png',
    bio: 'xD bug, czyli jak debugować PHP-owe aplikacje',
    twitterUrl: '#',
    linkedinUrl: '#',
  },
  {
    ...
    image:
      '../../../public/images/speakers/mateuszgarbarczyk.png',
